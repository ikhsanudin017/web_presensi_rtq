...
export default function Home() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center gap-8 p-6 overflow-hidden">
      ...
      <h1 className="text-4xl md:text-6xl font-extrabold text-center tracking-tight">Presensi Rumah Tahfidz Quran</h1>
      ...
      <div className="flex gap-3">
        <Link className="px-5 py-2.5 rounded-md bg-primary hover:bg-primaryDark text-white shadow-sm ring-1 ring-primary/30 transition-colors" href="/login">Masuk</Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl mt-2">
        <Link href="/dashboard/ustadz" className="block rounded-lg border p-6 hover:border-primary hover:bg-primaryMuted transition shadow-sm">
          <h2 className="text-xl font-semibold mb-1">Untuk Ustadz/Ustadzah</h2>
