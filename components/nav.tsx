...
export default function Nav() {
  ...
  return (
    <nav className="w-full border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-md p-3 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <Link href="/" className="font-semibold text-primary">Presensi RTQ</Link>
        <Link href="/dashboard" className="text-sm opacity-80 hover:text-primary">Dashboard</Link>
      </div>
